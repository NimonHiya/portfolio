          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-center gap-16">
            ...
            <div className="lg:w-1/2 space-y-6 text-center lg:text-left animate-fade-in-up">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-300 leading-relaxed hover:text-gray-100 transition-colors duration-300">
                  I&apos;m also in the process of expanding my team, with a vision to develop widely recognized applications that resonate with the community. My goal is to establish a career focused on building inclusive and accessible applications through thoughtfully designed code and user-centered principles that foster engaging experiences.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed hover:text-gray-100 transition-colors duration-300">
                  When I&apos;m away from my laptop, you can find me enjoying movies, gaming, or playing music.
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-6 justify-center lg:justify-start">
                <a
                  href="https://github.com/NimonHiya"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-300"
                >
                  <SiGithub className="w-6 h-6 text-gray-300 hover:text-white" />
                </a>
                <a
                  href="https://www.instagram.com/nimonhiya/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-300"
                >
                  <SiInstagram className="w-6 h-6 text-gray-300 hover:text-white" />
                </a>
                <a
                  href="https://www.linkedin.com/in/juan-farrel-88b66a236/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-300"
                >
                  <SiLinkedin className="w-6 h-6 text-gray-300 hover:text-white" />
                </a>
                <a
                  href="mailto:nimonhiya@gmail.com"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-300 animate-pulse-slow"
                >
